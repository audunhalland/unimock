...
#[test]
#[should_panic(
    expected = "T2::c(2): Method matched in wrong order. Expected a call matching T1::a(2) at tests/test_mock_order.rs:25."
)]
...
#[test]
#[should_panic(
    expected = "T1::a(0): Method invoked in the correct order (3), but inputs didn't match T1::a(1) at tests/test_mock_order.rs:58."
)]
...
#[test]
#[should_panic(
    expected = "T1::a(0): Method invoked in the correct order (1), but inputs didn't match T1::a(1 | 2) at tests/test_mock_order.rs:71."
)]
...
#[test]
#[should_panic(
    expected = "T1::a(0): Method invoked in the correct order (1), but inputs didn't match T1::a(x) if {guard} at tests/test_mock_order.rs:80."
)]
